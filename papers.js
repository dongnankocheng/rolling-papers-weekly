...
const PAPERS = [
  ...
  {
    "id": "p-125",
    "title": "A prospective plant-level material flow analysis to assess systemic efficiency in the transition to hydrogen-based steelmaking",
    "titleCn": "前瞻性工厂级物质流分析，用于评估向氢基炼钢过渡的系统效率",
    "authors": "M. Langhorst, Romain G. Billy, Xingqiang Song, Daniel B. Müller",
  ...
  },
  {
    ...
    "innovationCn": "在机器学习最新进展的推动下，轧钢正在向以数据为中心的智能运营转型。这项研究提出了一个统一的机器学习框架，用于对热轧和冷轧过程中的带钢进行预测、闭环质量控制。该模型明确量化了关键操作参数（例如轧制力和间隙设置）对最终产品质量的复杂非线性影响。所提出的框架能够实时监控和动态补偿尺寸偏差和形状缺陷，从而提高尺寸一致性和工艺稳定性。此外，还引入了基于多模态感知的系统，用于早期异常检测和协调参数优化，促进自适应设定点调整和主动缺陷缓解。总的来说，这些机器学习驱动的方法提高了产品的一致性和轧制效率，同时提供了一条可扩展的途径，实现更加自主、资源高效和可持续的轧制操作，与人工智能驱动的可持续制造的范式保持一致。",
    "innovationFormula": "机器学习与智能预测 + 型线轧制 + 轧制实验 = 工艺优化",
    "doi": "10.3389/fmats.2026.1921706"
  },
  {
    "id": "p-127",
    "title": "Direct Laser Interference Patterning as the final step in functionalization of Ti-based biomedical materials",
    "titleCn": "直接激光干涉图案化是钛基生物医学材料功能化的最后一步",
    "authors": "Donata Kuczyńska-Zemła, Jarosław Pura, Agata Sotniczuk, Maciej Spychalski et al.",
    ...
    "processType": "cold",
    "innovationTags": [],
    "abstract": "This paper investigates the influence of the substrate – particularly its phase composition and crystal defect density – on the surface properties of Ti-based materials after direct laser interference patterning (DLIP) processing. Hence, two titanium biomedical alloys (CP-Ti and Ti-Nb-Ta-Zr), in both microcrystalline states and after plastic deformation (cold rolling), were subjected to DLIP under identical laser parameters to produce a micrometric groove-like surface pattern. The modified surfaces were characterized in terms of microstructure, roughness, chemical composition, wettability, and mechanical properties. Furthermore, corrosion tests were performed in Hank’s solution to assess the impact of the surface treatment on the investigated system’s corrosion resistance in biomedical applications. The results demonstrated that DLIP universal is a promising and versatile technique for modifying the surface of both Ti-alloys, demonstrating its applicability for modification of materials with different independently of the phase composition and crystal defect density. The most pronounced differences in surface properties between the microcrystalline and cold-rolled states after DLIP were observed in the nitrogen content in the surface layer, as well as in the water contact angle and surface roughness. Which may be directly related to the substrate ’ s grain size before laser treatment. However, for each material, the corrosion resistance remained comparable between the different states. The proposed DLIP treatment resulted in the formation of periodic grooves for all investigated substrates; however, the archived surface topography was strongly influenced by the characteristics of each substrate. DLIP resulted in homogenization of corrosion and mechanical behavior rather than all surface properties. Comparison of the corrosion resistance of DLIP and polished samples revealed distinct behavior in the microcrystalline and cold-rolled states. For the microcrystalline samples, corrosion resistance was governed primarily by the air-formed oxide film rather than by the surface topography induced by DLIP. For the cold-rolled states, DLIP appeared to suppress the beneficial effect of the higher density of structural defects on corrosion resistance.",
    "innovationCn": "本文研究了基材（特别是其相组成和晶体缺陷密度）对直接激光干涉图案化（DLIP）加工后钛基材料表面性能的影响。因此，两种钛生物医用合金（CP-Ti 和 Ti-Nb-Ta-Zr）在微晶状态和塑性变形（冷轧）后，在相同的激光参数下进行 DLIP，以产生微米级凹槽状表面图案。改性表面的特征包括微观结构、粗糙度、化学成分、润湿性和机械性能。此外，在 Hank 的溶液中进行了腐蚀测试，以评估表面处理对所研究系统在生物医学应用中的耐腐蚀性的影响。结果表明，DLIP 通用技术是一种有前途且通用的技术，可用于改性两种钛合金的表面，证明其适用于具有不同相组成和晶体缺陷密度的不同材料的改性。 DLIP 后微晶状态和冷轧状态之间的表面性能最显着的差异体现在表面层的氮含量以及水接触角和表面粗糙度方面。这可能与激光处理前基材的晶粒尺寸直接相关。然而，对于每种材料，不同状态之间的耐腐蚀性仍然具有可比性。所提出的 DLIP 处理导致所有研究的基材形成周期性凹槽；然而，存档的表面形貌受到每种基材特性的强烈影响。 DLIP 导致腐蚀和机械行为的均匀化，而不是所有表面特性的均匀化。 DLIP 和抛光样品的耐腐蚀性能的比较揭示了微晶状态和冷轧状态下的不同行为。对于微晶样品，耐腐蚀性主要由空气形成的氧化膜决定，而不是由 DLIP 引起的表面形貌决定。对于冷轧状态，DLIP 似乎抑制了较高密度的结构缺陷对耐腐蚀性的有益影响。",
    "innovationFormula": "DEFORM + 组织演变与性能调控 + 冷轧工艺 = 组织调控",
    "doi": "10.1016/j.jmrt.2026.09.035"
  },
  {
    "id": "p-128",
    "title": "A multi-objective hot rolling scheduling optimization based on K-modes clustering and surrogate-assisted NSGA-II",
    "titleCn": "基于K模式聚类和代理辅助NSGA-II的多目标热轧调度优化",
    "authors": "Wenchao Deng, Guodong Zhao, Yun Dong, Qingxin Guo",
    ...
    "innovationTags": [],
    "abstract": "",
    "innovationCn": "基于K模式聚类和代理辅助NSGA-II的多目标热轧调度优化。主要涉及process等方面的创新研究。",
    "innovationFormula": "工艺优化与参数设计 + 热轧工艺 + 轧制实验 = 调度优化",
    "doi": "10.1016/j.asoc.2026.116329"
  },
  {
    "id": "p-129",
    "title": "A hierarchical multi-task learning-based electrical energy consumption prediction method with application to the hot strip rolling mill process",
    "titleCn": "基于分层多任务学习的电能消耗预测方法及其在热轧带钢轧机过程中的应用",
    "authors": "Kai Zhang, Zongxu Cao, Kaixiang Peng, Yibin Rui",
    "journal": "Expert Systems with Applications",
    "sourceType": "SCI",
    "year": 2026,
    "month": 9,
    ...
    "innovationTags": [],
    "abstract": "",
    "innovationCn": "基于分层多任务学习的电能消耗预测方法及其在热轧带钢轧机过程中的应用。主要涉及process等方面的创新研究。",
    "innovationFormula": "工艺优化与参数设计 + 热轧工艺 + 轧制实验 = 性能预测",
    "doi": "10.1016/j.eswa.2026.134256"
  },
  {
    "id": "p-130",
    "title": "Effect of Strip Width on Strip Shape in Ultra-Wide-Strip Tandem Cold Mill",
    "titleCn": "超宽带钢冷连轧机带钢宽度对板形的影响",
    "authors": "L. Li, Hongqiang Liu, Xindong Wang, Haibo Xie et al.",
    "journal": "Metals",
    "sourceType": "SCI",
    "year": 2026,
    "month": 9,
