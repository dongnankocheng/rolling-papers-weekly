...
const PAPERS = [
  ...
  {
    "id": "p-084",
    "title": "Angular backlash observer for the electromechanical systems of a rolling mill stand",
    "titleCn": "用于轧机机架机电系统的角间隙观测器",
    "authors": "Rifkhat R. Khramshin, B. M. Loginov, Andrey A. Radionov, Artem Litvinov et al.",
    "journal": "Известия высших учебных заведений Электромеханика",
    "sourceType": "SCI",
    "year": 2026,
    "month": 6,
    "innovationScore": 8,
    ...
    "processType": "hot",
    "innovationTags": [],
    "abstract": "An increase in backlash due to joint wear leads to dynamic shocks with negative consequences. In this regard, the task is set to develop an angular backlash observer that monitors their values at specified intervals. A digital twin development based on Simulink Real-Time software using Hardware-in-the-Loop (HIL) simulation technology is proposed. The virtual model of the electromechanical system is developed using Simscape domains and Matlab Simulink modules, which ensures its relative simplicity and versatility. A method for indirect determination (estimation) of the backlash value by measuring motor currents and speeds in the roll rocking mode (with a triangular tachogram of the electric drive) is proposed. The structure of the measuring system is presented, including an angular backlash estimation circuit and a virtual model of the electric drive based on Simscape blocks. Oscillograms confirming the reliability of the ob-tained results are investigated. When processing signals measured in the electromechanical system, significant amplitudes of the motor torque and elastic torque on the spindle in the slab gripping mode were confirmed. A significant dif-ference in backlash between the upper and lower roll drives was established. A conclusion is drawn about the satisfactory accuracy of angular backlash estimation and the effectiveness of the developed measuring system. The presented digital observer is recommended for use in operating conditions, as well as for the development of systems for limiting the amplitude of elastic torque",
    "innovationCn": "由于关节磨损而导致的间隙增加会导致动态冲击，从而产生负面后果。在这方面，任务是开发一种角度间隙观察器，以指定的时间间隔监测它们的值。提出了一种基于 Simulink Real-Time 软件并使用硬件在环 (HIL) 仿真技术的数字孪生开发方法。机电系统的虚拟模型是使用Simscape域和Matlab Simulink模块开发的，这保证了其相对简单性和通用性。提出了一种通过测量辊摇摆模式下的电机电流和速度（使用电力驱动器的三角形转速图）来间接确定（估计）齿隙值的方法。介绍了测量系统的结构，包括角间隙估计电路和基于 Simscape 块的电力驱动虚拟模型。研究了确认所得结果可靠性的波形图。当处理机电系统中测量的信号时，证实了板坯夹持模式下电机扭矩和主轴上的弹性扭矩的显着幅值。上辊驱动装置和下辊驱动装置之间的齿隙存在显着差异。得出的结论是角间隙估计的精度令人满意以及所开发的测量系统的有效性。建议在操作条件下使用所提出的数字观测器，以及用于限制弹性扭矩振幅的系统的开发。",
    "innovationFormula": "数字孪生 + 磨损分析 + 数字孪生与在线监测 = 热轧工艺优化",
    "doi": "10.17213/0136-3360-2026-2-71-82"
  },
  {
    "id": "p-085",
    "title": "A Robust and Highly Integrated Laser Doppler Velocimeter for High-Precision Velocity Measurement of Hot-Rolled Bars Under Thermal Radiation",
    "titleCn": "一种坚固且高度集成的激光多普勒测速仪，用于热辐射下热轧棒材的高精度速度测量",
    "authors": "Zimu Li, Lewen Zhang, Cheng Zuo, Jinhui Shi et al.",
    "journal": "Sensors",
    "sourceType": "SCI",
    "year": 2026,
    "month": 6,
  ...
  },
  {
    ...
    "processType": "cold",
    "innovationTags": [],
    "abstract": "The plasticity of bulk metallic glasses (BMGs) is closely correlated with the nature of shear bands; however, the structural origin of shear bands remains elusive due to the difficulty of obtaining direct observations. In this study, we investigated the microstructural evolution of shear bands during thermal relaxation by examining the local atomic-scale response to heating. Zr&lt;sub&gt;52.5&lt;/sub&gt;Cu&lt;sub&gt;17.9&lt;/sub&gt;Ni&lt;sub&gt;14.6&lt;/sub&gt;Al&lt;sub&gt;10&lt;/sub&gt;Ti&lt;sub&gt;5&lt;/sub&gt; BMGs were subjected to two specifically designed deformation methods, namely, cold rolling and high-pressure torsion (HPT), to generate shear bands with varying volume fractions and rejuvenation states. In situ synchrotron diffraction results revealed a more pronounced growth of medium-range ordering at sub-T&lt;sub&gt;g&lt;/sub&gt; temperatures in the deformed BMGs than in the as-cast sample. The HPT-deformed BMG, with the highest volume fraction and distribution complexity of shear bands, demonstrated the most rapid increase in the ordering process. The transition of cluster connection modes possibly explained the anomalous emergence of medium-range order in the shear bands of deformed BMGs during sub-T&lt;sub&gt;g&lt;/sub&gt; relaxation or tension. Our study offers new insights into the atomic structure origins of shear bands, contributing to a deeper understanding of BMG plasticity.",
    "innovationCn": "大块金属玻璃（BMG）的塑性与剪切带的性质密切相关；然而，由于难以获得直接观测，剪切带的结构起源仍然难以捉摸。在这项研究中，我们通过检查局部原子尺度对加热的响应来研究热弛豫过程中剪切带的微观结构演化。 Zr<sub>52.5</sub>Cu<sub>17.9</sub>Ni<sub>14.6</sub>Al<sub>10</sub>Ti<sub>5</sub>BMGs采用两种专门设计的变形方法，即冷轧和高压扭转（HPT），以产生具有不同体积分数和再生状态的剪切带。原位同步加速器衍射结果表明，在变形 BMG 中，在亚 T<sub>g</sub> 温度下，中程有序性比铸态样品中的增长更为明显。 HPT变形BMG具有最高的体积分数和剪切带的分布复杂性，在排序过程中表现出最快的增长。簇连接模式的转变可能解释了在亚T<sub>g</sub>松弛或拉伸过程中变形BMG剪切带中中程有序的异常出现。我们的研究为剪切带的原子结构起源提供了新的见解，有助于更深入地了解 BMG 可塑性。",
    "innovationFormula": "DEFORM + 有限元与多物理场仿真 + 冷轧工艺 = 冷轧工艺优化",
    "doi": "10.20517/microstructures.2026.06"
  },
  {
    "id": "p-088",
    "title": "Influence of hot rolling strategies on the microstructure and mechanical properties of a twin-roll cast WZ73 alloy",
    "titleCn": "热轧策略对双辊铸造WZ73合金显微组织和力学性能的影响",
    "authors": "Franziska Ueberschär, Marianthi Karadimitropoulou, Madlen Ullmann, Spyros Papaefthymiou et al.",
  ...
  },
  {
    ...
    "innovationCn": "本研究提出了一个全面的数据驱动框架，用于预测工业铝冷轧机的能耗。冷轧是铝生产过程中能源最密集的阶段之一。虽然传统的基于物理的模型不足以满足实时应用的需要，但现有的机器学习研究在很大程度上忽视了铝特定的过程动力学和可解释性维度。使用的工业数据集包含 2022 年以来的 1,345 条生产记录。具有物理意义的特征，例如压缩比、厚度减少和单位能耗（SEC，千瓦时/吨）均来自原始工艺变量。采用线性回归、Ridge 和 Lasso 作为基线模型，并与包括随机森林、梯度提升、XGBoost、LightGBM 和 CatBoost 在内的集成学习器进行比较。在随机分割下，CatBoost 实现了最佳性能（ \\(R^2 = 0.78\\) ），而在更现实的时间分割下，随机森林和梯度提升表现最佳（ \\(R^2 \\approx 0.81\\) ）。线性模型在时间评估下急剧退化（\\(R^2\\approx 0.18\\)）。 SHAP 分析表明，CVC 位置和滚动速度是模型预测的主要驱动因素。消融研究表明，删除 CVC 位置特征组导致 \\(R^2\\) 分数从 0.80 下降到 0.20。所提出的框架通过共同提供：滚动感知能源指标推导、集成模型系列的公平比较、基于 SHAP 的可解释性以及基于 SEC 效率分层的 CO \\(_2\\) 核算分析，解决了文献中的重大空白。",
    "innovationFormula": "随机森林 + XGBoost + LightGBM = 厚度精度",
    "doi": "10.1007/s42452-026-09036-8"
  },
  {
    "id": "p-090",
    "title": "Study of the effect of deformation rate and temperature on the energy and power parameters of the stainless steel billet piercing process in a two-high piercing mill with guide rollers",
    "titleCn": "导辊二辊穿孔机不锈钢钢坯穿孔过程变形率和温度对能量和功率参数影响的研究",
    "authors": "K. A. Usanov, Ya. I. Kosmatskiy, V. N. Eremin, A. A. Korsakov et al.",
    "journal": "Chernye Metally",
    "sourceType": "SCI",
    "year": 2026,
    "month": 7,
    ...
    "processType": "tube",
    "innovationTags": [],
    "abstract": "Demand for stainless steel pipes is currently growing steadily, driven by the development of the nuclear energy and oil and gas sectors. The subject of this study is a piercing mill with guide rollers in a pipe rolling unit with a pilger mill. A key challenge in piercing is the selection of routes and deformation modes that ensure minimal energy parameters combined with minimal heating temperatures for stainless steel. Solving this problem through direct industrial testing on a piercing mill carries risks associated with equipment failures and high experimental costs. Using QForm 2D/3D software, a numerical experiment was conducted on piercing billets into 08Kh18N10T steel sleeves at various temperatures and deformation rates to determine the energy-power parameters reserve of a piercing mill. It was found that reducing the piercing temperature from 1280 to 1230 &deg;C would increase the roll torque by 15 %, making piercing impossible. Expressions were derived for calculating torque depending on roll speed and deformation temperature. The simulation results showed satisfactory agreement with the actual energy-power parameters of the piercing mill in terms of torque. The study provided a scientifically based methodology for assessing energy-power parameters when piercing billets made of stainless and other steel grades and alloys.",
    "innovationCn": "目前，在核能和石油天然气行业发展的推动下，不锈钢管的需求稳步增长。本研究的主题是皮尔格轧机的轧管装置中带有导辊的穿孔机。穿孔的一个关键挑战是选择路线和变形模式，以确保不锈钢的最小能量参数和最小加热温度。通过在穿孔机上直接进行工业测试来解决这个问题会带来与设备故障和高实验成本相关的风险。利用QForm 2D/3D软件，对不同温度和变形率下的08Kh18N10T钢套穿孔坯进行数值试验，确定穿孔机的能量-功率参数储备。研究发现，将穿孔温度从 1280 °C 降低至 1230 °C 会使轧辊扭矩增加 15%，从而无法进行穿孔。导出了根据辊速和变形温度计算扭矩的表达式。仿真结果表明，在扭矩方面，与穿孔机的实际能量功率参数吻合良好。该研究提供了一种基于科学的方法，用于评估穿孔由不锈钢和其他钢种和合金制成的钢坯时的能量功率参数。",
    "innovationFormula": "DEFORM + 有限元与多物理场仿真 + 管材轧制 = 管材轧制优化",
    "doi": "10.17580/chm.2026.06.10"
  },
  {
    "id": "p-091",
    "title": "Improvement of the method for calculating hot rolling force taking into account the effect of temperature on elastic properties of alloyed construction steel strips",
    "titleCn": "考虑温度对合金结构钢带弹性性能影响的热轧力计算方法的改进",
    "authors": "I. D. Pospelov",
  ...
  },
  {
    ...
    "processType": "hot",
    "innovationTags": [],
    "abstract": "The paper presents the results of examination of the structure and properties of low-alloy steel, which is aimed on manufacturing coiled tubing for Arctic application, depending on different parameters of thermomechanical treatment. Based on the data about structural and phase transformations of overcooled austenite in steel, the temperature and speed processing indicators were selected and realized in the reversed hot rolling mill DUO-500, which is combined with the accelerated cooling system. These indicators meet the requirements of API Specification 5ST for the steel with ST80 strength class within the defined range (from 190 HV / 90 HRB to 240 HV / 99 HRB). The processing parameters, which ensure forming of fine-dispersed ferrite-bainite steel structure and thus achieving the highest level of tough and ductile properties at the preset strength level, were established. The research was carried out in the Nosov Magnitogorsk&nbsp;State Technical University on the expense of the grant of&nbsp;Russian scientific fund No. 25-29-20085 dated 14.05.2025,&nbsp;as well as on the expense of remedies of the Ministry of Education&nbsp;and Science of the Chelyabinsk region (Agreement&nbsp;No. 30-2025-002767 dated 07.07.2025), https://rscf.ru/project/25-29-20085/.",
    "innovationCn": "本文介绍了低合金钢的组织和性能检查结果，旨在根据不同的形变处理参数制造北极应用的连续油管。根据钢中过冷奥氏体的组织和相变数据，选择温度和速度加工指标，并在与加速冷却系统相结合的可逆式热轧机DUO-500上实现。这些指标满足API规范5ST对ST80强度等级钢在规定范围内（从190 HV / 90 HRB到240 HV / 99 HRB）的要求。确定了加工参数，确保形成细弥散的铁素体-贝氏体钢组织，从而在预设的强度水平下实现最高水平的韧性和延展性。该研究是在诺索夫马格尼托哥尔斯克国立技术大学进行的，费用为2025年5月14日第25-29-20085号俄罗斯科学基金拨款，以及车里雅宾斯克地区教育和科学部的补救措施（日期为第30-2025-002767号协议） 2025 年 7 月 7 日），https://rscf.ru/project/25-29-20085/。",
    "innovationFormula": "相变控制 + 组织演变与性能调控 + 热轧工艺 = 热轧工艺优化",
    "doi": "10.17580/cisisr.2026.01.09"
  },
  {
    "id": "p-093",
    "title": "Study of the deformability of AK7 alloy",
    "titleCn": "AK7合金变形性能研究",
    "authors": "I. L. Konstantinov, S. B. Sidelnikov, Yu. V. Baykovskiy, V. A. Berngardt et al.",
    ...
    "processType": "hot",
    "innovationTags": [],
    "abstract": "Simulations using the DEFORM software have shown that during hot rolling of cast billets made of AK7 alloy with a total reduction of more than 36.7%, there is a high probability of cracking, whereas heat-treated specimens can be deformed to the same extent without cracking. These results were confirmed by a physical experiment conducted using the hot rolling method. Studies of the microstructure of wheel blanks produced by low-pressure die casting have shown that heat treatment under the following conditions: heating to 540 &deg;C, holding for 6 hours, and air cooling, leads to a change in shape as well as a reduction in the size of eutectic silicon due to fragmentation and spheroidization, which increases the alloy&rsquo;s ductility by approximately twofold. Industrial testing showed that when rolling 19-inch wheel rims with a total reduction of 44.1%, the yield of usable parts was 40% for wheels rolled in the as-cast condition, whereas no cracks were observed in the heat-treated blanks after rolling, and the&nbsp;yield of usable parts reached 100%. The research was carried out within the framework of&nbsp;the state assignment of the Ministry of Science and Higher&nbsp;Education of the Russian Federation for Siberian Federal&nbsp;University (scientific theme code FSRZ-2020-0013).",
    "innovationCn": "利用DEFORM软件进行模拟表明，总压下量超过36.7%的AK7合金铸坯在热轧过程中，极有可能产生开裂，而热处理后的试件可以达到相同程度的变形而不会开裂。这些结果通过使用热轧方法进行的物理实验得到证实。对低压铸造车轮毛坯显微组织的研究表明，在以下条件下进行热处理：加热至540℃，保温6小时，然后空冷，会导致形状变化，并且由于碎裂和球化而导致共晶硅尺寸减小，从而使合金的延展性提高约两倍。工业试验表明，在轧制19英寸轮辋时，总压下量为44.1%，铸态轧制车轮可用件合格率为40%，而轧制后热处理毛坯未观察到裂纹，可用件合格率达到100%。该研究是在俄罗斯联邦科学和高等教育部西伯利亚联邦大学国家任务（科学主题代码 FSRZ-2020-0013）的框架内进行的。",
    "innovationFormula": "DEFORM + 有限元与多物理场仿真 + 热轧工艺 = 组织调控",
    "doi": "10.17580/nfm.2026.01.05"
  },
  {
    "id": "p-094",
    "title": "Evaluation of energy-power parameters of billet helical piercing in accordance with metal forming peculiarities in deformation zone",
    "titleCn": "根据变形区金属成形特性评价钢坯螺旋穿孔能量-功率参数",
    "authors": "A. O. Khalezov, Д. Ш. Нухов, E. A. Gregorev",
    "journal": "Izvestiya Ferrous Metallurgy",
    "sourceType": "SCI",
    "year": 2026,
    "month": 7,
  ...
  },
  {
    ...
    "innovationTags": [],
    "abstract": "",
    "innovationCn": "基于预测优化和数据驱动验证的人工智能驱动带钢热轧楔形控制。主要涉及ml等方面的创新研究。",
    "innovationFormula": "机器学习与智能预测 + 热轧工艺 + 轧制实验 = 板形控制",
    "doi": "10.1016/j.engappai.2026.115539"
  },
  {
    "id": "p-098",
    "title": "Online Monitoring of Phase Transformation Evolution in Hot Rolled Steels during Controlled Cooling",
    "titleCn": "热轧钢控冷过程中相变演化的在线监测",
    "authors": "Tata Steel, Haibing Yang, Tata Steel, Frenk Van Den Berg et al.",
    ...
    "processType": "hot",
    "innovationTags": [],
    "abstract": "The evolution of steel’s phase transformation from austenite to other metallurgical phases during the cooling process in a hot strip mill is measured in real time by a Transformation Monitor system. Four sensor heads are installed along the rolling direction on the run-out cooling table (ROT). It is demonstrated that not only the phase transformation but also the transformation rate over strip length can be measured. This provides information complimentary to pyrometer-based surface temperature measurements and thereby gives greater visibility of the dynamic transformation process throughout the ROT.",
    "innovationCn": "在热带钢轧机的冷却过程中，钢从奥氏体到其他冶金相的相变演变由相变监测系统实时测量。四个传感器头沿轧制方向安装在跳动冷却台（ROT）上。结果表明，不仅可以测量相变，还可以测量带材长度上的相变速率。这为基于高温计的表面温度测量提供了补充信息，从而提高了整个 ROT 动态转变过程的可视性。",
    "innovationFormula": "相变控制 + 组织演变与性能调控 + 热轧工艺 = 热轧工艺优化",
    "doi": "10.58286/32993"
  },
  {
    "id": "p-099",
    "title": "A Dual-Stream Deep Reinforcement Learning Framework for Hot Rolling Production Scheduling",
    "titleCn": "用于热轧生产调度的双流深度强化学习框架",
    "authors": "C Q Wang, Wang Cao, Min Huang",
    "journal": "Machines",
    "sourceType": "SCI",
    "year": 2026,
    "month": 6,
